...
import { carsState, clotheSize, clotheStuff, currency, menClotheCategory, typeOfPrice } from '../../data/database';
import Toast from '../../customs/Toast';

export default function MenClothing({ formData, onBack, onChange, onNext }) {
    ...
    const fields = [
        ...
        { label: 'Catégorie', name: 'category', type: 'select', options: menClotheCategory.fr, message: 'La catégorie est requise.', required: true },
