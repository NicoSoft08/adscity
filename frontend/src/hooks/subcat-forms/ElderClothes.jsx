...
export default function ElderClothes({ formData, onBack, onChange, onNext }) {
    ...
    const fields = [
        { label: 'Titre de l\'annonce', name: 'title', type: 'text', placeholder: "Ex: T-Shirt Nike unisexe noir", message: 'Le titre est requis.', required: true },
        { label: 'Genre', name: 'gender', type: 'select', options: elderGender.fr, message: 'Le genre est requis.', required: true },
        { label: 'Marque', name: 'brand', type: 'text', placeholder: 'Ex: Nike', message: 'La marque est requise.', required: true },
        { label: 'Catégorie', name: 'category', type: 'select', options: elderClothingCategory.fr, message: 'La catégorie est requise.', required: true },
