...
import { carsState, currency, typeOfPrice, womenShoesCat, womenShoesSize } from '../../data/database';
import Toast from '../../customs/Toast';

export default function WomenShoes({ formData, onBack, onChange, onNext }) {
    ...
    const fields = [
        ...
        { label: 'Catégorie', name: 'category', type: 'select', options: womenShoesCat.fr, message: 'La catégorie est requise.', required: true },
        { label: 'Marque', name: 'brand', type: 'text', message: 'La marque est requise.', required: true },
        { label: 'Taille', name: 'size', type: 'select', options: womenShoesSize.fr, message: 'La taille est requise.', required: true },
