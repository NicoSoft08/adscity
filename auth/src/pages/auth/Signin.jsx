        ...
        <div className='login-page'>
            <form className="login-form" onSubmit={handleSubmit}>
                ...
                <div className="terms-container">
                    <p>
                        <Link to={`${frontendUrl}/legal/privacy-policy`} target="_blank">{language === 'FR' ? "Règles de confidentialité" : "Privacy Policy"}</Link>{" - "}
                        <Link to={`${frontendUrl}/legal/terms`} target="_blank"> {language === 'FR' ? "Conditions d'utilisation" : "Terms of use"}</Link>
