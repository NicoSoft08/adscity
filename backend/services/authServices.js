...
router.post('/create/user', async (req, res) => {
    ...
    try {
        const newUser = await createUser(
            ...
            phoneNumber, displayName, country, city, address
        );
...
router.post('/verify/user-token', verifyToken, async (req, res) => {
    try {
        ...
        // if (isNewDevice) {
        //     await sendNewDeviceAlert(userID, email, displayName, deviceInfo, deviceRef.id);
        // }
