...
import { carsState, currency, menShoesCat, menShoesSize, typeOfPrice } from '../../data/database';
import Toast from '../../customs/Toast';

export default function MenShoes({ formData, onBack, onChange, onNext }) {
    ...
    const fields = [
        ...
        { label: 'Catégorie', name: 'category', type: 'select', options: menShoesCat.fr, message: 'La catégorie est requise.', required: true },
        { label: 'Marque', name: 'brand', type: 'text', message: 'La marque est requise.', required: true },
        { label: 'Taille', name: 'size', type: 'select', options: menShoesSize.fr, message: 'La taille est requise.', required: true },
