        ...
        <div className="signup-page">
            <div className="signup-form">
                ...
                <div className="terms-container">
                    <p>
                        <Link to={`${frontendUrl}/legal/privacy-policy`} target="_blank">Confidentialité</Link>{" - "}
                        <Link to={`${frontendUrl}/legal/terms`} target="_blank">Conditions d'utilisation</Link>
