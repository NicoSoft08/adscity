...
export default function ConditionPage() {
    return (
        <div className='terms'>
            <h1>Conditions Générales de Vente d'AdsCity</h1>
            <p>Bienvenue sur AdsCity, votre plateforme de petites annonces en ligne. Les présentes Conditions Générales de Vente (CGV) régissent l'utilisation des services fournis par AdsCity. En accédant à notre site et en utilisant nos services, vous acceptez ces conditions dans leur intégralité.</p>

            <h2>Objet</h2>
            <p>Les présentes CGV ont pour objet de définir les modalités de mise à disposition des services de la plateforme AdsCity et les conditions de vente des annonces proposées par les utilisateurs.</p>
            ...
            <p>Pour bénéficier des services d'AdsCity, l'Utilisateur doit créer un compte en remplissant le formulaire d'inscription en ligne. L'Utilisateur s'engage à fournir des informations exactes et à mettre à jour ses données en cas de changement. AdsCity se réserve le droit de suspendre ou de supprimer tout compte en cas de violation des présentes CGV ou de la réglementation en vigueur.</p>
            ...
            <p>AdsCity se réserve le droit de modifier les présentes CGV à tout moment. Toute modification sera publiée sur cette page. Les utilisateurs seront informés de toute modification via le site.</p>
